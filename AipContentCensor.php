...
class AipContentCensor extends AipBase
{
    ...
    private $documentCensorSubmitUrl = "https://aip.baidubce.com/rest/2.0/solution/v1/solution/document/v1/submit";
    private $documentCensorPullUrl = "https://aip.baidubce.com/rest/2.0/solution/v1/solution/document/v1/pull";
     ...
     */
    public function documentCensorFileSubmit($fileName, $document, $options = array())
    {

        $data = array();

        $data['fileBase64'] = base64_encode($document);
        $data['fileName'] = $fileName;
        $data = array_merge($data, $options);
        return $this->request($this->documentCensorSubmitUrl, $data);
    }
     ...
     * https://ai.baidu.com/ai-doc/ANTIPORN/2l8484xvl
     */
    public function documentCensorUrlSubmit($fileName, $url, $options = array())
    {
     ...
     */
    public function documentCensorPull($taskId, $options = array())
    {

        $data = array();
        $data['taskId'] = $taskId;
        $data = array_merge($data, $options);
        return $this->request($this->documentCensorPullUrl, $data);
    }
} 
